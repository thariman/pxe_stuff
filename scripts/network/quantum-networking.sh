...
FIXED_RANGE="10.10.10.0/24"	# The IP range for the private tenant network
NETWORK_GATEWAY="10.10.10.1"	# The Gateway Tenant-VMs will receive as default gw
...
EXT_GW_IP="192.168.16.101"

# IP of the Public Network Gateway - The 
# default GW in our official Internet IP address space:
EXT_NET_GATEWAY="192.168.16.1"

# Floating IP range
POOL_FLOATING_START="192.168.16.105"	# First public IP to be used for VMs
POOL_FLOATING_END="192.168.16.120"	# Last public IP to be used for VMs 
